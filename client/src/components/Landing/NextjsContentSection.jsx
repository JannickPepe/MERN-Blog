...
import { nextjsContentStates } from "../../utils/contenStates";
...
const NextjsContentSection = () => {
    const [currentState, setCurrentState] = useState(0);
    const badges = ["Scaleable", "Middlewares", "Type Safe", "PostgreSQL"];
            ...
            <div className="Content-Body col-span-1 md:col-span-8">
                ...
                >
                    <h3 className="mb-4 text-xl text-neutral-600 md:text-2xl font-bold">
                        {nextjsContentStates[currentState].title}
                    </h3>
                    
                    <ul className="text-lg space-y-2">
                        {nextjsContentStates[currentState].items.map((item, index) => (
                            <motion.li
                                key={index}
                ...
                <div className="mt-6 flex justify-center space-x-4">
                    {nextjsContentStates.map((_, index) => (
                        <button
                            key={index}
...
export default NextjsContentSection;