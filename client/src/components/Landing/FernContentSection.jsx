...
import { fernContentStates } from '../../utils/contenStates';
            ...
            <div className="Content-Body col-span-1 md:col-span-8">
                ...
                >
                    <h3 className="mb-4 text-xl text-neutral-600 md:text-2xl font-bold">
                        {fernContentStates[currentState].title}
                    </h3>
                    
                    <ul className="text-lg space-y-2">
                        {fernContentStates[currentState].items.map((item, index) => (
                            <motion.li
                                key={index}
...
export default FernContentSection;
