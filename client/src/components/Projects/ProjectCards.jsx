...
export const ProjectCards = () => {
    return (
        <section className="bg-white px-8 py-12">
            <div className="mx-auto grid max-w-3xl grid-cols-1 gap-6 md:gap-10 sm:grid-cols-2">
                <Card
                    title="MERN"
    ...
    return (
        ...
        >
            <motion.div
                whileHover="hovered"
                className={twMerge(
                    "group w-full border-2 border-black bg-emerald-300 rounded-md",
                    className
                )}
            >
                <motion.div
                ...
                className={twMerge(
                    "-m-0.5 border-2 border-black bg-emerald-300 rounded-md",
                    className
                )}
                >
                    <motion.div
                        ...
                        className={twMerge(
                            "relative -m-0.5 flex h-72 flex-col justify-between overflow-hidden border-2 border-black bg-emerald-300 p-8 rounded-md",
                            className
                        )}
                    >
...
// Add PropTypes for Card component
Card.propTypes = {
...
Card.defaultProps = {
    className: '', // Default empty string if className is not passed
};
